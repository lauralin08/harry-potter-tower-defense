 ...
 */
game.HUD.SpellCastingPower = me.Renderable.extend({
    init: function(x, y) {
        this._super(me.Renderable, 'init', [x, y, 10, 10]);
    ...
    update: function(dt) {
        ...
        if (this.power !== game.data.power) {
            this.poewr = game.data.power;
            return true;
        }
        return false;
    },
    ...
    draw: function(renderer) {
        // this will display the spell casting power in the bottom right
        this.font.draw(renderer, game.data.power, me.game.viewport.width + this.pos.x,
